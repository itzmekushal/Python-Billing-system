from tkinter import * #MOST COMMELY USED GUI APPLICATION
from tkinter import ttk #ACCESS TO TK THEME WIDGET
...
class LoginPage:
    def __init__(self,win):
        ...
        self.title_label = Label(self.win,text="Billing Management System",font=('Arial',35,'bold'),bg="lightgrey",bd=8,relief=GROOVE)
...
#-========================main frame================================================
        ...
        self.login_lbl = Label(self.main_frame,text="login",bd=6,relief=GROOVE,anchor=CENTER,bg="orange",font=('sans-serif',25,'bold'))
        ...
        self.entus_lbl = Label(self.entry_frame,text="Enter Username: ",fg="white",bg="black",font=('sans=serif',15))
        ...
        self.entus_ent = Entry(self.entry_frame,font=('sans-serif',15),bd=6,bg="orange",fg="black",textvariable=username)
        ...
        self.entpass_ent = Entry(self.entry_frame,font=('sans-serif',15),bd=6,bg="orange",fg="black",textvariable=password,show="*")
        ...
        def check_login():
            ...
            if username.get() == "MIT2021" and password.get() == "2021":
        ...
        #=======================BUTTONS====================
        self.button_frame = LabelFrame(self.entry_frame,text="Options",font=('Arial',15),bg="orange",bd=7,relief=GROOVE)
...
class Window2:
    def __init__(self,win):
        ...
        self.title_label = Label(self.win,text="Electronic - Billing Management System",font=('Arial',35,'bold'),bg="orange",bd=8,relief=GROOVE)
        self.title_label.pack(side=TOP,fill=X)
    #======================================= ENTRY =================================
     ...
     #======================variables ==============================================      
        ...
        #=========================default==========================
        def default_bill(): 
            self.bill_txt.insert(END,"\t\t\t            Cafe Illusion")
